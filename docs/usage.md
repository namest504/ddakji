...
- **묶기**: 툴바의 모음집 버튼(카드 아이콘) → 기존 모음집 선택 또는 새 이름 입력.
  ...
  **노트 창을 다른 노트 위에 겹치게 드래그해서 놓아도** 합쳐집니다 (창 크기가
  서로 달라도 작은 쪽이 충분히 덮이면 흡수됩니다). 겹치는 동안 창이 어두워지며
  예고하고, **마우스를 놓아야** 합쳐집니다 — 옮기다 잠깐 멈춘 것만으로는
  합쳐지지 않습니다. 합친 직후 잠깐 뜨는 **되돌리기**로 무를 수 있습니다.
