...
export const ko = {
  ...
  dismissNotice: "안내 닫기",
  // 병합 예고 칩 (#171)
  mergeChip: "『{title}』에 합치기",
  mergeChipUntitled: "여기에 놓으면 합쳐집니다",
  // 우클릭 메뉴 (#172)
  ctxCut: "잘라내기",
  ctxCopy: "복사",
  ctxPaste: "붙여넣기",
  ...
  langSystem: "시스템",
  aiSection: "AI 연동",
  installSkill: "Claude 스킬 설치",
  skillInstalled: "설치됨: {path}",
  copyMcp: "MCP 설정 복사 (Claude Desktop 등)",
  mcpCopied: "복사됨 — MCP 클라이언트 설정에 붙여넣으세요",
  openCliFolder: "CLI 위치 열기 (ddakji-cli)",
  storage: "저장 위치",
...
export const en: Record<MsgKey, string> = {
  ...
  undo: "Undo",
  // 병합 예고 칩 (#171)
  mergeChip: "Merge into “{title}”",
  mergeChipUntitled: "Drop here to merge",
  // 우클릭 메뉴 (#172)
  ctxCut: "Cut",
  ctxCopy: "Copy",
  ctxPaste: "Paste",
  ctxBold: "Bold",
  ctxTask: "Turn into checklist",
  ctxArrange: "Arrange windows",
  ctxList: "Note list",
  ctxHide: "Hide this page",
  ctxFlip: "Show back",
  ctxClose: "Close window",
  ...
  installSkill: "Install the Claude skill",
  skillInstalled: "Installed: {path}",
  copyMcp: "Copy MCP config (Claude Desktop, …)",
  mcpCopied: "Copied — paste into your MCP client's config",
  openCliFolder: "Open CLI location (ddakji-cli)",
